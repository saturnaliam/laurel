...
void test_serialization() {
  ...
  message_header_t no_error_header = { .magic_number = "LRL", .command_type = Command::PLAY, .version = 0, .body_length = 5 };
  ...
  message_header_t magic_number_error_header = { .magic_number = "LRR", .command_type = Command::PLAY, .version = 0, .body_length = 5 };
  ...
  message_header_t version_error_header = { .magic_number = "LRL", .command_type = Command::PLAY, .version = 1, .body_length = 5 };
  ...
  message_header_t size_error_header = { .magic_number = "LRL", .command_type = Command::PLAY, .version = 0, .body_length = 7 };
